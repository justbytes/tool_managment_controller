...
class WorkOrder:
    ...
    def __create__(self):
        ...
        worksheet['C3'].value = self.workOrder['order_number']
        ...
        for tool in tools:
            ...
            worksheet['C' + str(row)].value = tool['tool_serial_number']
            worksheet['E' + str(row)].value = tool['tool_cal_date']
...
workOrder = input_data['updatedWorkOrder']
